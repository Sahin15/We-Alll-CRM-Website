...
import { createLicense } from "../../api/softwareLicenseApi";
import "./AddSoftwareLicense.css";

const AddSoftwareLicense = () => {
  ...
  return (
    <Container fluid className="add-software-license-page py-4">
      <Row className="mb-4">
        <Col>
          <h1 className="page-title">Add New Software License</h1>
        </Col>
      </Row>
...
export default AddSoftwareLicense;
