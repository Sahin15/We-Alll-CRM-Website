      ...
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100 }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <img src="/Wealll_mini.png" alt="WeAlll" style={{ width: '32px', height: '32px', objectFit: 'contain' }} />
          ...
          {user && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <button onClick={() => setShowDropdown(v => !v)} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', padding: '4px' }}>
                {user.profilePicture ? (
                  <img src={user.profilePicture} alt={user.name} style={{ width: '34px', height: '34px', borderRadius: '50%', objectFit: 'cover', border: '2px solid rgba(255,255,255,0.6)' }} />
                ) : (
